...
>
	<div
		style="background:#2a2e1a; border:0.5px solid #4a5520; border-radius:12px; padding:32px; width:100%; max-width:400px;"
	>
		<div style="text-align:center; margin-bottom:24px;">
			<h1 style="font-size:22px; font-weight:500; color:#c8d870; margin-bottom:8px;">
				Forgot Password
			</h1>
		...
		<div style="text-align:center;">
			<a
				href="/login"
				style="color:#c8d870; font-size:13px; text-decoration:none;"
				onmouseenter={(e) => (e.target.style.color = '#d6e08a')}
				onmouseleave={(e) => (e.target.style.color = '#c8d870')}>← Back to Login</a
			>
		</div>
	</div>
</div>
